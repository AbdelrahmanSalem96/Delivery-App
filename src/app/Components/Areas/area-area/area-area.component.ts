...
@Component({
  selector: 'app-area-area',
  templateUrl: './area-area.component.html',
  styleUrl: './area-area.component.css'
})
export class AreaAreaComponent {
  ...
  regionidsearchfield:string=InitialConstants.DefaultSelectedDropDownListString;
  ...
  onSubmit(addForm:NgForm){
    ...
    if(addForm.valid){
      if(this.area.name.trim().length == InitialConstants.DefaultInt){
        ...
        this._dataServiceService.notificationService.showErrorNotification(BodyMessageEnum.RegionIsRequiredMessage);
        this._dataServiceService.spinnerService.hide();
        this.isdisabledbutton=InitialConstants.DefaultOffDisabled;
      }else{
        if(this.area.id != InitialConstants.DefaultString){
          ...
          this.createArea.areaType=AreaTypeEnum.Area;
  ...
  onOpenDialog(id:string,name:string) {
    ...
    dialogConfig.data = {message:"Do You Want To Delete Area "+ name + " ? "};
  ...
  onSearch(){
    ...
    this.searchObj.Value=AreaTypeEnum.Area.toString();
    ...
    if(this.regionidsearchfield != InitialConstants.DefaultSelectedDropDownListString){
      this.searchObj=new SearchObj();
      this.searchObj.Name="ParentId";
      this.searchObj.Value=this.regionidsearchfield;
  ...
  onResetSearchForm(){
    ...
    this.regionidsearchfield = InitialConstants.DefaultSelectedDropDownListString;
