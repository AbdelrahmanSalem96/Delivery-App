...
@Component({
  selector: 'app-region-area',
  templateUrl: './region-area.component.html',
  styleUrl: './region-area.component.css'
})
export class RegionAreaComponent {
  ...
  countryidsearchfield:string=InitialConstants.DefaultSelectedDropDownListString;
  ...
  ngOnInit(): void {
    ...
    searchAreaObjs.Value=AreaTypeEnum.Country.toString();
  ...
  onSubmit(addForm:NgForm){
    ...
    if(addForm.valid){
      if(this.area.name.trim().length == InitialConstants.DefaultInt){
        ...
        this._dataServiceService.notificationService.showErrorNotification(BodyMessageEnum.CountryIsRequiredMessage);
        this._dataServiceService.spinnerService.hide();
        this.isdisabledbutton=InitialConstants.DefaultOffDisabled;
      }else{
        if(this.area.id != InitialConstants.DefaultString){
          ...
          this.createArea.areaType=AreaTypeEnum.Region;
  ...
  onOpenDialog(id:string,name:string) {
    ...
    dialogConfig.data = {message:"Do You Want To Delete Region "+ name + " ? "};
  ...
  onSearch(){
    ...
    this.searchObj.Value=AreaTypeEnum.Region.toString();
    ...
    if(this.countryidsearchfield != InitialConstants.DefaultSelectedDropDownListString){
      this.searchObj=new SearchObj();
      this.searchObj.Name="ParentId";
      this.searchObj.Value=this.countryidsearchfield;
  ...
  onResetSearchForm(){
    ...
    this.countryidsearchfield=InitialConstants.DefaultSelectedDropDownListString;
