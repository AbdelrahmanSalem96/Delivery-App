...
@Component({
  selector: 'app-captin-search',
  templateUrl: './captin-search.component.html',
  styleUrl: './captin-search.component.css'
})
export class CaptinSearchComponent implements OnInit{
